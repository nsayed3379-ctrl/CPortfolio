...
export const formInputClass =
  "focus-ring w-full min-h-[46px] rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-base text-[var(--color-paper)] placeholder:text-[var(--color-muted-2)] outline-none transition-colors focus:border-[var(--color-electric-soft)] disabled:opacity-50 disabled:pointer-events-none";
